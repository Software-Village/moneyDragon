    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                MainPasswordTextInput(text = rePassword, label = R.string.re_password)
            }
            Spacer(modifier = Modifier.height(40.dp))
            MainButton(
                ...
                if (email.value.isNotEmpty() && password.value.isNotEmpty() && rePassword.value.isNotEmpty()) {
                    if (rePassword.value == password.value) {
                        viewModel.setEvent(AuthEvent.RegisterUser(email.value, password.value))
                    } else {
                        Toast.makeText(
                            context,
